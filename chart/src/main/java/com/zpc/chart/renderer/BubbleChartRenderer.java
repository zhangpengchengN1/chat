...
import com.zpc.chart.data.BubbleEntry;
import com.zpc.chart.interfaces.dataprovider.BubbleDataProvider;
import com.zpc.chart.interfaces.datasets.IBubbleDataSet;
...
public class BubbleChartRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    protected void drawDataSet(Canvas c, IBubbleDataSet dataSet) {
        ...
        for (int j = mXBounds.min; j <= mXBounds.range + mXBounds.min; j++) {
            ...
            final BubbleEntry entry = (BubbleEntry) dataSet.getEntryForIndex(j);
        ...
        if (isDrawingValuesAllowed(mChart)) {
            ...
            for (int i = 0; i < dataSets.size(); i++) {
                ...
                for (int j = 0; j < positions.length; j += 2) {
                    ...
                    BubbleEntry entry = (BubbleEntry) dataSet.getEntryForIndex(j / 2 + mXBounds.min);
