...
import com.zpc.chart.listener.PieRadarChartTouchListener;
    ...
    public void calculateOffsets() {
        ...
        if (mLegend != null && mLegend.isEnabled() && !mLegend.isDrawInsideEnabled()) {
            ...
            switch (mLegend.getOrientation()) {
                case Legend.LegendOrientation.VERTICAL: {
                    ...
                    switch (mLegend.getHorizontalAlignment()) {
                        case Legend.LegendHorizontalAlignment.LEFT:
                            legendLeft = xLegendOffset;
                            break;

                        case Legend.LegendHorizontalAlignment.RIGHT:
                            legendRight = xLegendOffset;
                            break;

                        case Legend.LegendHorizontalAlignment.CENTER:
                            switch (mLegend.getVerticalAlignment()) {
                                case Legend.LegendVerticalAlignment.TOP:
                                    legendTop = Math.min(mLegend.mNeededHeight,
                                            mViewPortHandler.getChartHeight() * mLegend.getMaxSizePercent());
                                    break;
                                case Legend.LegendVerticalAlignment.BOTTOM:
                ...
                case Legend.LegendOrientation.HORIZONTAL:
